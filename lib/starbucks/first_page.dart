...
class StarbucksFirstPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Sliver 위젯들을 이용하려면 CustomScrollView를 사용해야 합니다.
          CustomScrollView(
            slivers: [
              // 스크롤시 배경이 사라지게 만들려면 SliverAppBar 위젯을 사용하면 됩니다.
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                // LinearProgressIndicator가 끝없이 길어지지 않도록 Column의 가로 길이를 Row의 남은 자리만큼만 차지하도록 만들어줌
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment:
              ...
              // CustomScrollView 안에서는 모든 첫 번째 위젯이 Sliver로 구현 되어야 함
              // SliverToBoxAdapter는 Container와 같은 위젯이라고 보면 됨
              SliverToBoxAdapter(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        scrollDirection: Axis.horizontal, // 횡 스크롤
                        itemCount: 100,
